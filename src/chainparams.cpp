...
public:
    CMainParams()
    {
        ...
        printf("%s", txNew.vin[0].scriptSig.ToString());
        ...
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 0x80); // Start with '5' or 'K' or 'L'(as in Bitcoin)
        ...
        fMiningRequiresPeers = false; // TODO: Need to convert it to true after deploying
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zpch to be stakable
...
public:
    CTestNetParams()
    {
        ...
        // Testnet popchain BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet popchain BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet popchain BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // POPCHAIN: 1 day
        nTargetSpacing = 1 * 60;        // POPCHAIN: 1 minutes
