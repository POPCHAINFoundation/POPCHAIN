Contributing to Popchain Core
============================

The Popchain Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/popchain-project/popchain/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Popchain Core project, and is not to be
confused with overall Popchain Network Protocol consensus changes.

Whether a pull request is merged into Popchain Core rests with the project merge
...
Patches that change Popchain consensus rules are considerably more involved than
...
Where a patchset proposes to change the Popchain consensus, it must have been
...
The project leader is the release manager for each Popchain Core release.
