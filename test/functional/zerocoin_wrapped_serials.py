...
from fake_stake.base_test import POPCHAIN_FakeStakeTest

class zPCHwrappedSerialsTest(POPCHAIN_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zPCHs..." % DENOM_TO_USE)
