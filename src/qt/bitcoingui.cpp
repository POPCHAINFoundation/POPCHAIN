                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PCH Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PCH address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and popchain: URIs)"));
...
//    privacyAction->setStatusTip(tr("Privacy Actions for zPCH"));
...
//#endif
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PCH Core"), this);
    aboutAction->setStatusTip(tr("Show information about PCH Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for POPCHAIN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PCH addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PCH addresses"));
    ...
    openAction->setStatusTip(tr("Open a POPCHAIN: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PCH Core help message to get a list with possible PCH command-line options"));
...
//        toolbar->widgetForAction(spacer)->setObjectName("ToolbarSpacer");
        ...
        QLabel* labelPCHLogo = new QLabel();
        labelPCHLogo->setObjectName(QStringLiteral("labelPCHLogo"));
	labelPCHLogo->setMinimumSize(QSize(140, 140));
        labelPCHLogo->setAlignment(Qt::AlignCenter|Qt::AlignTrailing|Qt::AlignVCenter);

        toolbar->addWidget(labelPCHLogo);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PCH Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PCH network", "", count));
}
...
{
    QString strTitle = tr("PCH Core"); // default title
