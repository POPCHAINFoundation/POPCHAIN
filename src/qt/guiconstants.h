...
/* Popchain GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "POPCHAIN"
#define QAPP_ORG_DOMAIN "popchain.org"
#define QAPP_APP_NAME_DEFAULT "POPCHAIN-Qt"
#define QAPP_APP_NAME_TESTNET "POPCHAIN-Qt-testnet"
