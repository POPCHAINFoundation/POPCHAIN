                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zPCH || context == Context::BIP_38 || context == Context::UI_Vote) {
    ...
    // It doesn't make sense to show the checkbox for sending PCH because you wouldn't check it anyway.
    if (context == Context::Send_PCH || context == Context::Send_zPCH) {
            ...
            if (newpass1 == newpass2) {
                if (model->setWalletEncrypted(true, newpass1)) {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("PCH will close now to finish the encryption process. "
                               "Remember that encrypting your wallet cannot fully protect "
                               "your PCHs from being stolen by malware infecting your computer.") +
                            "<br><br><b>" +
