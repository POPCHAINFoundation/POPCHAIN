...
This means one can have an always-on popchaind instance running, and another local popchaind/popchain-qt instance which connects to this node and receives blocks from it.
