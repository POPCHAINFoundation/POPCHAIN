...
RESOURCES += src/qt/popchain.qrc src/qt/popchain_locale.qrc

TRANSLATIONS += src/qt/locale/popchain_bg.ts \
                src/qt/locale/popchain_de.ts \
                src/qt/locale/popchain_en.ts \
                src/qt/locale/popchain_es.ts \
                src/qt/locale/popchain_fi.ts \
                src/qt/locale/popchain_fr.ts \
                src/qt/locale/popchain_it.ts \
                src/qt/locale/popchain_ja.ts \
                src/qt/locale/popchain_pl.ts \
                src/qt/locale/popchain_pt.ts \
                src/qt/locale/popchain_ru.ts \
                src/qt/locale/popchain_sk.ts \
                src/qt/locale/popchain_sv.ts \
                src/qt/locale/popchain_vi.ts \
                src/qt/locale/popchain_zh_CN.ts \
                src/qt/locale/popchain_zh_TW.ts
