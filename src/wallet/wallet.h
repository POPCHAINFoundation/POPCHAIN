...
extern bool fGlobalUnlockSpendCache; // Bool used for letting the precomputing thread know that zpchspends need to use the cs_spendcache
...
public:
    ...
    string GetUniqueWalletBackupName(bool fzpchAuto) const;
    ...
    */
    ...
    bool fBackupMints;
    std::unique_ptr<CzPCHTracker> zpchTracker;
    ...
    {
        zwalletMain = zwallet;
        zpchTracker = std::unique_ptr<CzPCHTracker>(new CzPCHTracker(strWalletFile));
    }
