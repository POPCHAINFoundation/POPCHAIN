...
extern UniValue DoZpchSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzpchseed(const UniValue& params, bool fHelp);
extern UniValue getzpchseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzpch(const UniValue& params, bool fHelp);
extern UniValue dzpchstate(const UniValue& params, bool fHelp);
