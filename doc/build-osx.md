...
1. Clone the Popchain Core source code:

        git clone https://github.com/popchain-project/popchain
        cd popchain
...
Popchain Core is now available at `./src/popchaind`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/POPCHAIN"

    touch "/Users/${USER}/Library/Application Support/POPCHAIN/popchain.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/POPCHAIN/popchain.conf"

The first time you run popchaind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
...
-------
    ...
    ./src/popchaind -daemon # Starts the popchain daemon.
    ./src/popchain-cli --help # Outputs a list of command-line options.
    ./src/popchain-cli help # Outputs a list of RPC commands when the daemon is running.
