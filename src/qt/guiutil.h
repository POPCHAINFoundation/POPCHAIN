...
/** Utility functions used by the PCH Qt UI.
 */
namespace GUIUtil
{
...
// Render PCH addresses in monospace font
...
// Parse "popchain:" URI into recipient object, return true on successful parsing
